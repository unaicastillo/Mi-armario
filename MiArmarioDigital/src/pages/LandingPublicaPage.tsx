      ...
      <div>
        ...
        <div className="relative h-[400px] md:h-[500px] flex flex-col justify-center items-center text-white px-4 overflow-hidden bg-[#181818]">
            ...
            <img 
                src={bannerImage} 
                alt="Fondo" 
                className={`absolute inset-0 w-full h-full object-contain opacity-30 blur-sm md:scale-75 transition-transform duration-[2000ms] ease-out ${
                    isLoaded ? 'scale-125 md:scale-75' : 'scale-150 md:scale-100'
                }`}
            />
            ...
            <div className="relative z-10 text-center max-w-3xl w-full mt-8">
                ...
                {/* Barra blanca*/}
                <div className={`bg-white rounded-full mx-auto shadow-2xl shadow-black/20 h-10 md:h-12 w-[90%] sm:max-w-lg md:max-w-xl transition-all duration-1000 delay-500 ease-[cubic-bezier(0.34,1.56,0.64,1)] ${
